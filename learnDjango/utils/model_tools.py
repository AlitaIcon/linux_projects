...
class BaseModel(models.Model):
    ...
    created_time = models.DateTimeField(auto_now_add=datetime.datetime.now, verbose_name="创建时间", help_text="创建时间")
    updated_time = models.DateTimeField(auto_now=datetime.datetime.now, verbose_name="更新时间", help_text="更新时间")
